...
NUM_MON_SITES = 50 #total minotored sites
NUM_MON_INST_TEST = 3 #test traffic sequences/instance per site (monitored)
NUM_MON_INST_TRAIN = 7 #train traffic sequences/instance per site (monitored)
NUM_MON_INST = NUM_MON_INST_TEST + NUM_MON_INST_TRAIN
NUM_UNMON_SITES_TEST = 0 #test traffic sequences per site (unmonitored)
NUM_UNMON_SITES_TRAIN = 0 #train traffic sequences per site (unmonitored)
NUM_UNMON_SITES = NUM_UNMON_SITES_TEST + NUM_UNMON_SITES_TRAIN

seq_length = 4096

data_loc = "/Users/Amine/Desktop/Imperial College - CS/Spring term/Msc Project/batch_sample"
